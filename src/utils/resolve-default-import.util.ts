/**
 * Entrada: moduleExport: valor importado por defecto desde un paquete CJS/ESM.
 * Proceso: Normaliza el export default cuando TypeScript resuelve el modulo como namespace (NodeNext/Vercel).
 * Salida: Retorna la funcion exportada lista para invocar.
 */
